...
public class PaxZone {
    ...
    private void initEvent() {
        ...
        txtPaxOATotal.addTextChangedListener(new TextWatcher() {

            private PaxZoneDto paxZoneDto = PaxZone.this.paxZoneDto;
            private String preText;
            private AppCompatActivity thisContext = PaxZone.this.context;
        ...
        txtPaxOBTotal.addTextChangedListener(new TextWatcher() {
        ...
        txtPaxOCTotal.addTextChangedListener(new TextWatcher() {
